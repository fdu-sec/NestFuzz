...
EOF
# Build your target using fresh model clang.
test_clang++ -g test_fuzzer.cc -c
# Build this file, link it with the target code.
test_clang++ model_driver.cpp test_fuzzer.o
################################################################################
